...
{   
    ...
    private void swapCards(int cardARowIndex, int cardAColumnIndex, int cardBRowIndex, int cardBColumnIndex)
    {
        ...
        tempCard = cards[cardBRowIndex][cardBColumnIndex];
        cards[cardBRowIndex][cardBColumnIndex] = cards[cardARowIndex][cardAColumnIndex];
        cards[cardARowIndex][cardAColumnIndex] = tempCard;
    }
